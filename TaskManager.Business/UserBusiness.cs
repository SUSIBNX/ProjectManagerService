        ...
        public UserModel UserConverter(object user)
        {
            ...
            if (inputModel != null)
            {
                ...
                if (dic1.TryGetValue("UserId", out value))
                    userModel.UserId = (value == null || string.IsNullOrWhiteSpace(value.ToString())) ? 0 : Convert.ToInt16(value);
                if (dic1.TryGetValue("ProejctId", out value))
                    userModel.ProjectId = (value == null || string.IsNullOrWhiteSpace(value.ToString())) ? 0 : Convert.ToInt16(value);
                if (dic1.TryGetValue("TaskId", out value))
                    userModel.TaskId = (value == null || string.IsNullOrWhiteSpace(value.ToString())) ? 0 : Convert.ToInt16(value);
                return userModel;
            }
